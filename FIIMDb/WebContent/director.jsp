...
<body>
	...
	<div class="container">
		...
		<fieldset>
			...
			<% 
				String directorName = request.getParameter("name");
				directorBean.getDirectorByName(directorName);
			%>
			<div class="movie-container">
				<ul class="list-group">				
 					<%
						Director director = directorBean.getDirector();
					%>
					<li class="list-group-item">
						<div class="row">
							...
							<div class="col-sm-10">
								...
								Name:
								<%=director.getName() %> <br /> Nationality:
								<%=director.getNationality() %> <br /> Age:
								<%=director.getAge() %> <br /> Movies:
								<%=director.getMovie() %> <br />
							</div>
						</div>
					</li>
				</ul>
